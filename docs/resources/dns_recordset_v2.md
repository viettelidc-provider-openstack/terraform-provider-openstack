...
layout: "openstack"
page_title: "OpenStack: viettelidc_dns_recordset_v2"
...
resource "viettelidc_dns_recordset_v2" "rs_example_com" {
...
```
$ terraform import viettelidc_dns_recordset_v2.recordset_1 zone_id/recordset_id
```
