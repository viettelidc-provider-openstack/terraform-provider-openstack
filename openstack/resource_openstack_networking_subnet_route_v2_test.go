		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckNetworkingV2SubnetRouteExists("viettelidc_networking_subnet_route_v2.subnet_route_1"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2SubnetRouteExists("viettelidc_networking_subnet_route_v2.subnet_route_1"),
					testAccCheckNetworkingV2SubnetRouteExists("viettelidc_networking_subnet_route_v2.subnet_route_2"),
				),
			},
			{
				Config: testAccNetworkingV2SubnetRouteDestroy,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2SubnetRouteEmpty("viettelidc_networking_subnet_v2.subnet_1"),
				),
			},
		},
	})
...
func testAccCheckNetworkingV2SubnetRouteDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "viettelidc_networking_subnet_route_v2" {
			continue
		}
...
resource "viettelidc_networking_subnet_route_v2" "subnet_route_2" {
