		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingRouterV2DataSourceID("data.viettelidc_networking_router_v2.router"),
					resource.TestCheckResourceAttrSet(
						"data.viettelidc_networking_router_v2.router", "name"),
					resource.TestCheckResourceAttrSet(
						"data.viettelidc_networking_router_v2.router", "description"),
					resource.TestCheckResourceAttrSet(
						"data.viettelidc_networking_router_v2.router", "admin_state_up"),
					resource.TestCheckResourceAttrSet(
						"data.viettelidc_networking_router_v2.router", "status"),
					resource.TestCheckResourceAttr(
						"data.viettelidc_networking_router_v2.router", "tags.#", "1"),
					resource.TestCheckResourceAttr(
						"data.viettelidc_networking_router_v2.router", "all_tags.#", "2"),
				),
			},
		},
	})
...
resource "viettelidc_networking_router_v2" "router" {
  name           = "router_tf"
...
data "viettelidc_networking_router_v2" "router" {
  name           = "${viettelidc_networking_router_v2.router.name}"
  description    = "description"
  admin_state_up = "true"
  tags = [
    "foo",
