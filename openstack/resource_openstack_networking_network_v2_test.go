		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "name", "network_1"),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "description", "my network description"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "name", "network_2"),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "description", ""),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckNetworkingV2RouterInterfaceExists(
						"viettelidc_networking_router_interface_v2.ri_1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "external", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "transparent_vlan", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "admin_state_up", "true"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "admin_state_up", "false"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkWithExtensionsExists(
						"viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "port_security_enabled", "true"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkWithExtensionsExists(
						"viettelidc_networking_network_v2.network_1", &network),
					resource.TestCheckResourceAttr(
						"viettelidc_networking_network_v2.network_1", "port_security_enabled", "false"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(
						"viettelidc_networking_network_v2.network_1", "qos_policy_id"),
				),
			},
		},
	})
...
func testAccCheckNetworkingV2NetworkDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "viettelidc_networking_network_v2" {
			continue
		}
...
resource "viettelidc_networking_router_interface_v2" "ri_1" {
