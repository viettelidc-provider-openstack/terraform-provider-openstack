		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2("viettelidc_fw_group_v2.group_1", "", "", policyID),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2(
						"viettelidc_fw_group_v2.group_1", "group_1", "terraform acceptance test", policyID),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2(
						"viettelidc_fw_group_v2.group_1", "new_name_group_1", "new description terraform acceptance test", policyID),
				),
			},
			{
				Config: testAccFWGroupV2Basic1,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2(
						"viettelidc_fw_group_v2.group_1", "", "", policyID),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"viettelidc_fw_group_v2.group_1", "shared", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2Exists("viettelidc_fw_group_v2.group_1", &group),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWGroupV2Exists("viettelidc_fw_group_v2.group_1", &group),
					resource.TestCheckResourceAttr("viettelidc_fw_group_v2.group_1", "description", "firewall group port test"),
...
func testAccCheckFWGroupV2Destroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "viettelidc_fw_group_v2" {
			continue
		}
...
resource "viettelidc_fw_policy_v2" "ingress_firewall_policy_1" {
  name = "ingress_firewall_policy_1"
}

resource "viettelidc_fw_policy_v2" "egress_firewall_policy_1" {
  name = "egress_firewall_policy_1"
}

resource "viettelidc_fw_group_v2" "group_1" {
  ingress_firewall_policy_id = "${viettelidc_fw_policy_v2.ingress_firewall_policy_1.id}"
  egress_firewall_policy_id  = "${viettelidc_fw_policy_v2.egress_firewall_policy_1.id}"
}
`
...
resource "viettelidc_fw_group_v2" "group_1" {
  ...
  ports       = [
    "${viettelidc_networking_router_interface_v2.router_interface_1.port_id}",
  ]
}
`
...
resource "viettelidc_networking_router_interface_v2" "router_interface_2" {
  router_id = "${viettelidc_networking_router_v2.router_2.id}"
...
resource "viettelidc_fw_group_v2" "group_1" {
  ...
  ports                      = [
    "${viettelidc_networking_router_interface_v2.router_interface_1.port_id}",
    "${viettelidc_networking_router_interface_v2.router_interface_2.port_id}",
  ]
}
`
